...
# unittests are essential to ensure that code you've written continues 
...
class UserModelCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # creates a database from scratch that's useful for testing
        db.create_all()
    ...
    def test_follow(self):
        ...
        db.session.add(u2)
        db.session.commit()
        # asserts that the condition is equal to an empty list
